...
Sema::Sema(Preprocessor &pp, ASTContext &ctxt, ASTConsumer &consumer,
  ...
  : ExternalSource(nullptr),
    ...
    CachedNSStringDecl(nullptr), CachedNSArrayDecl(nullptr),
    CachedNSDictionaryDecl(nullptr), CachedNSNumberDecl(nullptr),
    CachedNSValueDecl(nullptr), StringWithUTF8StringMethod(nullptr),
    ValueWithBytesObjCTypeMethod(nullptr),
    _ArrayWithObjectsMethod(nullptr), _DictionaryWithObjectsMethod(nullptr),
